...
Python is generally regarded as an easy programming language to learn and is used in many introductory courses. Python scripts are denoted by the *.py* file type extension. Comments are denoted by the `#` symbol. 
